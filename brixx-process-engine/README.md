...
### [Brixx-Process-Engine Version 1.6.0 (64-bit)](https://brixx.it/@brixx/setup/Brixx-Process-Engine-v1.6.0-x64.exe)

## <i class="fa-brands fa-linux"></i> Linux Installer

Download Web-Application Package Installer for Linux.

### [Brixx-Process-Engine Version 1.6.0 (Linux)](https://brixx.it/@brixx/setup/Brixx-Process-Engine-v1.6.0-linux.run)

## <i class="fa-brands fa-apple"></i> Mac OS Installer

Download Web-Application Package Installer for Mac OS.

### [Brixx-Process-Engine Version 1.6.0 (Mac OS)](https://brixx.it/@brixx/setup/Brixx-Process-Engine-v1.6.0-macos.run)
